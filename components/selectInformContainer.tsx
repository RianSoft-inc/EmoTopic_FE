export default function SelectInformContainer({ click, setClick }: any) {
  return (
    <>
      <div
    ...
    sm:flex-row-reverse dark:bg-gray-900 dark:bg-opacity-60 dark:backdrop-blur-md  shadow-lg
     shadow-black/10 ring-2 ring-transparent 
      ...
      >
        <p
          className={`fa-solid fa-chevron-right fa-2xl flex-none  tracking-tight text-gray-900 dark:text-white ${
